...
class FlexionesDiamante(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    ...
    override fun analyzeDataEjercicio(
        ...
        datosEjercicio.porcentajeSucces = (( abs((angleA-angles[datosEjercicio.form][0])/(angles[datosEjercicio.form][0])) +
                ...
                abs((angleD-angles[datosEjercicio.form][4])/(angles[datosEjercicio.form][4])))/3)*100
