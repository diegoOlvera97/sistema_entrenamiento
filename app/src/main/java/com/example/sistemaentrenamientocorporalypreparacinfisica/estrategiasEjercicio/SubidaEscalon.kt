...
class SubidaEscalon(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    val ayudaTrigonometrica = AyudaTrigonometrica()
    val imageResources = listOf(
        R.drawable.upescalon
    )
    ...
    override fun getPoseCSV(): List<String> {
        return listOf("pose/fitness_poses_escalon.csv", "escalon_left")
    }

    override fun getNameEjercicio(): String {
        return "Subida escalon"
    }
}