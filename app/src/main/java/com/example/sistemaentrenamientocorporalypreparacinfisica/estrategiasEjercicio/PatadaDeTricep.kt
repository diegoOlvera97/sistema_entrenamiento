...
class PatadaDeTricep(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    val ayudaTrigonometrica = AyudaTrigonometrica()
    val imageResources = listOf(
        R.drawable.patada_de_triceps
    )
    ...
    override fun analyzeDataEjercicio(
        ...
        datosEjercicio.porcentajeSucces = (( abs((angleA-angles[datosEjercicio.form][0])/(angles[datosEjercicio.form][0])) +
                ...
                abs((angleD-angles[datosEjercicio.form][3])/(angles[datosEjercicio.form][3])))/6)*100
        ...
        if(  confirmAngle(angleA,angles[datosEjercicio.form][0]) > probabilidad &&
            ...
            /*
            confirmAngle(angleG,angles[datosEjercicio.form][6]) > probabilidad &&
    ...
    override fun getPoseCSV(): List<String> {
        return listOf("pose/fitness_poses_patada.csv", "patada_beside")
    }
