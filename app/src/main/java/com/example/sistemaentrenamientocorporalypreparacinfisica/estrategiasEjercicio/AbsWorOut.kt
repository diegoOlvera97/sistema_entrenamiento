...
class AbsWorOut(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    ...
    override fun analyzeDataEjercicio(
        ...
        if( angleA/(angles[datosEjercicio.form][0]) > probabilidad &&
            ...
            angleI/(angles[datosEjercicio.form][8]) > probabilidad &&
            angleJ/(angles[datosEjercicio.form][9]) > probabilidad
            ){
