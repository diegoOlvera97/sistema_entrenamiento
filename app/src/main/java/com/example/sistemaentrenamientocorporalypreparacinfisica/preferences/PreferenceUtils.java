package com.example.sistemaentrenamientocorporalypreparacinfisica.preferences;
...
public class PreferenceUtils {
    ...
    public static CameraSource.SizePair getCameraPreviewSizePair(Context context, int cameraId) {
        ...
        if (cameraId == CameraSource.CAMERA_FACING_BACK) {
            previewSizePrefKey = context.getString(com.example.sistemaentrenamientocorporalypreparacinfisica.R.string.pref_key_rear_camera_preview_size);
    ...
    public static boolean shouldPoseDetectionRunClassification(Context context) {
        ...
        return sharedPreferences.getBoolean(prefKey, true);//Se activo para que pudiera empezar la detección de clasificación de poss
    }
