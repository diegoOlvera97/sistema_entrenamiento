...
class Wipers(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    ...
    override fun analyzeDataEjercicio(
        ...
        datosEjercicio.porcentajeSucces = ((
                abs((angleG-angles[datosEjercicio.form][6])/(angles[datosEjercicio.form][6])) +
                abs((angleH-angles[datosEjercicio.form][7])/(angles[datosEjercicio.form][7])) +
                ...
                abs((angleE-angles[datosEjercicio.form][4])/(angles[datosEjercicio.form][4])) +
                abs((angleF-angles[datosEjercicio.form][5])/(angles[datosEjercicio.form][5])))/6)*100

        if(  confirmAngle(angleG,angles[datosEjercicio.form][6]) > probabilidad &&
            confirmAngle(angleH,(angles[datosEjercicio.form][7])) > probabilidad &&
    ...
    override fun getPoseCSV(): List<String> {
        return listOf("pose/fitness_poses_wipers.csv", "wipers_derecha")
    }
