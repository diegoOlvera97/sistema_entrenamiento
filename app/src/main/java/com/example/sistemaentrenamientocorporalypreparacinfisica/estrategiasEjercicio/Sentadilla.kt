...
class Sentadilla(private val datosEjercicio: DatosEjercicioActual): TipoDeEjercicio {
    ...
    override fun analyzeDataEjercicio(
        ...
        datosEjercicio.porcentajeSucces = ((
                abs((angleA-angles[datosEjercicio.form][0])/(angles[datosEjercicio.form][0])) +
                ...
                abs((angleE-angles[datosEjercicio.form][4])/(angles[datosEjercicio.form][4])))/4)*100
        /*
            angleA/(angles[datosEjercicio.form][0]) > probabilidad &&

            angleG/(angles[datosEjercicio.form][6]) > probabilidad &&
            angleH/(angles[datosEjercicio.form][7]) > probabilidad &&
    ...
    override fun getPoseCSV(): List<String> {
        return listOf("pose/fitness_poses_squad_out.csv","pushups_up")
    }
